...
export default function DashboardScreen({ navigation, route }: any) {
  ...
  // Feature cards with Woofadaar colors
  const features = [
    {
      icon: 'dog' as const,
            ...
            <View style={styles.heroContent}>
              <View style={styles.heroLeft}>
                ...
                <Text style={styles.heroMessage}>
                  You have {stats.dogCount} {stats.dogCount === 1 ? 'furry friend' : 'furry friends'} counting on you
                </Text>
                <View style={styles.heroBadge}>
                  <Ionicons name="trophy" size={16} color={Colors.primary.warmYellow} />
                  <Text style={styles.heroBadgeText}>{stats.points} points earned</Text>
                </View>
              </View>
              <View style={styles.heroRight}>
                <Image
                  source={require('../../assets/cute-dog-illustration.png')}
          ...
          <View style={styles.statsCard}>
            <View style={styles.statsGrid}>
              <View style={styles.statItemNew}>
                <View style={[styles.statIconContainer, { backgroundColor: Colors.secondary.mintTeal[20] }]}>
                  <MaterialCommunityIcons name="dog" size={20} color={Colors.primary.mintTeal} />
                </View>
              ...
              <View style={styles.statItemNew}>
                <View style={[styles.statIconContainer, { backgroundColor: Colors.secondary.mintTeal[20] }]}>
                  <Ionicons name="document-text" size={20} color={Colors.primary.mintTeal} />
                </View>
              ...
              <View style={styles.statItemNew}>
                <View style={[styles.statIconContainer, { backgroundColor: Colors.secondary.mintTeal[20] }]}>
                  <Ionicons name="trophy" size={20} color={Colors.primary.mintTeal} />
                </View>
