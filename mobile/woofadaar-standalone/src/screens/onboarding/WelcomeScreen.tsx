      ...
      <View style={styles.content}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Text style={styles.primaryButtonText}>I Have a Dog</Text>
          </TouchableOpacity>

          <TouchableOpacity
            style={styles.secondaryButton}
            onPress={() => {
              // Navigate to profile completion for future dog owners
              navigation.navigate('ProfileCompletion');
            }}
            activeOpacity={0.8}
          >
            <Text style={styles.secondaryButtonText}>Planning to Get a Dog</Text>
          </TouchableOpacity>
