...
import DogDiary from '@/components/diary/DogDiary';
import Link from 'next/link';
import { Dog, Plus, BookOpen } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <p className="text-gray-500 mb-6">
              Add your first dog to start documenting their journey and milestones.
            </p>
            <Link 
              href="/profile"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-milk-white via-gray-50 to-gray-100 px-4 py-6">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Dog Diary</h1>
          <p className="text-gray-600">Document your dog's journey, milestones, and special moments</p>
        </div>
